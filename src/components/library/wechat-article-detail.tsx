...
import type { WechatLibraryDetail } from "@/lib/content-creation-types";
    ...
    <main className="library-detail-layout">
      <div className="library-detail-shell">
        <div className="library-detail-toolbar">
          <Link className="page-return-link" href="/content-creation/library">
            <svg
              aria-hidden="true"
              fill="none"
              height="14"
          ...
          <Link className="page-return-link page-return-link--subtle" href="/content-creation">
            返回主页
          </Link>
        </div>

...
import type { DraftRecord, PlatformId } from "@/lib/content-creation-types";
  ...
  return (
    <section className="draft-inbox">
      <div className="draft-inbox__header">
        ...
        <button className="draft-inbox__create" onClick={props.onCreateDraft} type="button">
          新建草稿
        </button>
      </div>
      ...
      {props.isLoading ? <div className="draft-inbox__empty">正在读取草稿箱...</div> : null}
          ...
          return (
            ...
            >
              <div className="draft-card__meta">
                <span className="draft-card__status">{getDraftStatusLabel(draft.status)}</span>
                <div className="draft-card__meta-right">
              ...
              <div className="draft-card__chips">
                {draft.selectedPlatforms.length > 0 ? (
                  ...
                  <span className="draft-card__chip draft-card__chip--muted">尚未选择平台</span>
                )}
              </div>

...
const defaultImageModelSelections: PlatformImageModelSelections = {
...
export function SettingsShell(props: {
  initialImageModelSelections?: PlatformImageModelSelections;
  ...
  const [imageModelSelections, setImageModelSelections] =
    useState<PlatformImageModelSelections>(
      props.initialImageModelSelections ?? defaultImageModelSelections
    );
  ...
  async function savePlatformSelection(
    ...
    if (platformId === "wechat" || platformId === "xiaohongshu") {
      payload.imageModel = normalizeSiliconFlowImageModel(imageModel);
    }
  ...
  async function handleSave(platformId: PlatformId) {
    await savePlatformSelection(
      ...
      imageModelSelections[platformId]
    );
  }
  ...
  async function handleReset(platformId: PlatformId) {
    ...
    setImageModelSelections((current) => ({
      ...current,
      [platformId]: DEFAULT_SILICONFLOW_IMAGE_MODEL
    }));
  ...
  function updatePlatformImageModel(platformId: PlatformId, modelId: string) {
    setImageModelSelections((current) => ({
      ...current,
      [platformId]: normalizeSiliconFlowImageModel(modelId)
    }));
  }
    ...
    <main className="settings-layout">
      <aside className="settings-nav">
        ...
        <nav className="settings-nav__list">
          ...
          <Link className="settings-nav__button" href="/content-creation/library">
            内容库
          </Link>
        </nav>
      </aside>
        ...
        <div className="settings-grid">
          {platformPanels.map((panel) => (
            <PlatformRuleBindingPanel
              ...
              selectedImageModel={imageModelSelections[panel.key]}
              ...
              onSelectImageModel={(modelId) =>
                updatePlatformImageModel(panel.key, modelId)
              }
